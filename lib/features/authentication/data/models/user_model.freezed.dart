...
class _$UserModelImpl implements _UserModel {
  const _$UserModelImpl(
      ...
      final Map<String, dynamic> shippingAddress = const {}})
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, email: $email, name: $name, photoUrl: $photoUrl, favorites: $favorites, shippingAddress: $shippingAddress)';
  }
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      final Map<String, dynamic> shippingAddress}) = _$UserModelImpl;
